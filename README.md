# ember-one-way-select [![npm version](https://badge.fury.io/js/ember-one-way-select.svg)](https://badge.fury.io/js/ember-one-way-select) [![Ember Observer Score](http://emberobserver.com/badges/ember-one-way-select.svg)](http://emberobserver.com/addons/ember-one-way-select)

**[ember-one-way-select is built and maintained by DockYard, contact us for expert Ember.js consulting](https://dockyard.com/ember-consulting)**.
